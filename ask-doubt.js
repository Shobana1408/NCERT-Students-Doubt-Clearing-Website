...
(function () {
  ...
  /**
   * Optional override from JSP: window.NCERT_CHAPTERS_BY_SUBJECT = { "Science": ["Ch1", ...], ... }
   * Servlet may set this via inline script before this file loads.
   */
  var chaptersBySubject = window.NCERT_CHAPTERS_BY_SUBJECT || {
    Mathematics: [
      "Real Numbers",
      "Polynomials",
